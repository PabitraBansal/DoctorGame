package com.example.doctorgame;
...
public class MainActivity extends Activity implements View.OnTouchListener, View.OnDragListener, GestureDetector.OnGestureListener {
